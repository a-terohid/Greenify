...
const Aboutus = () => {
    return (
        <div className=' bg-environment-background w-screen bg-cover bg-no-repeat pb-40' >
            <div className='container text-center mt-14 ' >
                ...
                <div className='flex flex-col items-center justify-center' >
                    ...
                    <h2 className=' text-center my-8 font-kaoly w-fit text-PrimaryGreen py-1 px-6 bg-white rounded-lg text-lg lg:text-2xl' >Greenify</h2>
                </div>
